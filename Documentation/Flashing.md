...
There is the nice gui [Pinecil Firmware Updater](https://github.com/pine64/pinecil-firmware-updater/releases). In the event that this tool does not meet you needs, the below process may be used to update the firmware.
